...
test_that("function signature", {
  check_safepredict_signature(safe_predict.lm)
})
...
test_that("type = \"response\"", {
  check_predict(safe_predict.lm, fit, mtcars, "mpg", type = "response")
  check_predict(safe_predict.lm, fit, new_wt_df, "mpg", type = "response")
})

test_that("type = \"conf_int\"", {
  check_predict(safe_predict.lm, fit, mtcars, "mpg", type = "conf_int")
  check_predict(safe_predict.lm, fit, new_wt_df, "mpg", type = "conf_int")
})

test_that("type = \"pred_int\"", {
  check_predict(safe_predict.lm, fit, mtcars, "mpg", type = "pred_int")
  check_predict(safe_predict.lm, fit, new_wt_df, "mpg", type = "pred_int")
})
